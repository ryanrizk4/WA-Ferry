...
**Two reservations are held**, both taken by hand off these alerts:

| | Sailing | Cancel by, to avoid the no-show fee |
|---|---|---|
| Sunday 13th | **9:25 PM** | 5 p.m. Saturday 12th |
| Monday 14th | **7:05 AM** | 5 p.m. Sunday 13th |

Getting off the island is settled. Only one of these will be used, and **the
other must be cancelled** by the deadline above or WSF charges the no-show fee,
quoted at $16.00 on these sailings.

## What the watcher is still looking for

Two sailings, and nothing else. Both are improvements on what is already held:

1. **Monday 8:50 AM** — better than the 7:05 AM held, a gentler start on the
   day of the long drive.
2. **Sunday 10:45 PM** — better than the 9:25 PM held, more of Sunday on Orcas.

Everything else is silence now. An alert that cannot improve the trip only
costs attention.

If one of these comes up, the move is to **change** the existing reservation
rather than book a second one: changes are free before 5 p.m. the day before,
and a second reservation you do not use earns the no-show fee.
